...
CREATE INDEX idx_billing_documents_client_id ON billing_documents(client_id);
CREATE INDEX idx_billing_documents_payment_status ON billing_documents(payment_status);
