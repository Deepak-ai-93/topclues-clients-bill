...
import { loginUserAction, getServerSession } from '@/lib/actions';
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <div className="mb-6">
            <h2 className="text-xl font-bold tracking-tight text-neutral-900">Client Sign In</h2>
            <p className="text-sm text-neutral-500 mt-1">Enter your client credentials.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-neutral-600 uppercase tracking-wider" htmlFor="client_email">
                Email Address
              </label>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-neutral-600 uppercase tracking-wider" htmlFor="client_password">
                Password
              </label>
              <div className="relative">
          ...
          <div className="mt-6 pt-4 border-t border-neutral-100 text-center">
            <Link href="/admin/login" className="text-xs text-neutral-500 hover:text-primary transition-colors font-medium">
              Admin Portal Login →
            </Link>
          </div>
        </div>
